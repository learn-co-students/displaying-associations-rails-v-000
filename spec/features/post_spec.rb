...
#   before do
#     @post = Post.create(title: "My Post", description: "My post desc", category_id: 1)
#   end
#
...
#     @post = Post.create(title: "My Post", description: "My post desc", post_status: true, category_id: 1)
